   ...
   <table class="table table-bordered cart_summary">
    <thead>
     <tr>
      ...
      <th class="action"><span>Edit</span>
      </th>
    </tr>
  </thead>
  <?php $total = 0; ?>
  <?php if (isset($_SESSION['cart'])): ?>
    <?php foreach ($_SESSION['cart'] as $key => $value): ?>
      <form action="cart.php" method="GET">
       <tbody>
         <tr>
          <?php  $product = $objproduct->getItemById($key);?>
          <input type="hidden" name="id" value="<?php echo $key ?>">
          <td class="cart_product">
           <a href="#"><img src="public/images/<?php echo $product[0]['product_image'];  ?>" alt="Product" class="img-responsive"></a>
         </td>
         <td class="cart_description"><p class="product-name"><a href="#"><?php echo $product[0]["product_name"];  ?></a></p></td>
         <td class="price"><span><?php echo $product[0]["product_price"];  ?></span></td>
         <td class="qty">
           <input class="form-control input-sm" type="text" name="qty" value="<?php echo  $value ?>">
         </td>
         <td class="price">
           <span>
            <?php 
            echo $subtotal = ($value*$product[0]["product_price"]); 
            $total += $subtotal; 
            ?>
          </span>
        </td>
        <td class="action">
         <a class="btn-remove" href="action.php?action=delete&id=<?php  echo $key ?>">Delete item</a>
       </td>
       <td class="action">
        <button type="submit" name="btn-update" value="clicked">Update</button>
      </td>
    </tr>
  </form>
</tbody>
...
<tfoot>
 ...
 <tr>
  ...
  <td colspan="2"><strong><?php echo  $total; ?> VND</strong></td>
  <td colspan="1"><strong><a href="cart.php?action=delete_all">Delete ALL</a></strong></td>
